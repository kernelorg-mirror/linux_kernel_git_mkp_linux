			...
			int error)
{
	...
	switch (error) {
		...
		case -ECTRLGRD:
			r->r_error = ASM_ERR_CTRL_GRD;
			break;

		case -ECTRLAPP:
			r->r_error = ASM_ERR_CTRL_APP;
			break;

		case -ECTRLREF:
			r->r_error = ASM_ERR_CTRL_REF;
			break;

		case -EDISKGRD:
			r->r_error = ASM_ERR_DISK_GRD;
			break;

		case -EDISKAPP:
			r->r_error = ASM_ERR_DISK_APP;
			break;

		case -EDISKREF:
			r->r_error = ASM_ERR_DISK_REF;
			break;
